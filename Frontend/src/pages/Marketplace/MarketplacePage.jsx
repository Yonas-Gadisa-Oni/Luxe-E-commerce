  ...
  return (
    <div className="marketplace-page">
      ...
      <main>
        ...
        <section className="vendor-cta"><div><p className="marketplace-kicker">YOUR CRAFT HAS A PLACE HERE</p><h2>Turn your work into a storefront.</h2><p>Join a growing community of independent sellers reaching customers who care where their things come from.</p></div><Link to="/vendor/dashboard">Start selling <ArrowRight size={17} /></Link></section>
      </main>
      <Footer />
    </div>
  );
